...
export const Two = ()=>{
    ...
    ramble.potential_reponses.push(new PlayerResponse("So this is where you talk to me directly?", Three));
...
export const Three = ()=>{
    ...
    const ramble = new JRRamble("Yeah. If you want to? Don't get me wrong, Zampanio has been a lot of fun and I really love that people are still lost in it...", []);
...
export const Six = ()=>{
    ...
    const ramble = new JRRamble("I really like it when there's people here. Seeing what I'm creating. Creating their own things and showing me. Documenting what they've found, so I can see. ", []);
...
export const Seven = ()=>{
    ...
    const ramble = new JRRamble("I also want them to be safe, and to not be get so obsessed they feel trapped.", []);

    ramble.potential_reponses.push(new PlayerResponse("In Truth, the goals aren't conflicting.", Eight));
...
export const Eight = ()=>{
    ...
    const ramble = new JRRamble("Even tho sometimes it feels that way. ", []);

    ramble.potential_reponses.push(new PlayerResponse("People should leave if they're not having fun. And at the same time, I can take steps to try to prevent it from going sour? ", Nine));
...
export const Nine = ()=>{
    ...
    const ramble = new JRRamble("I can remind you to hydrate and takes breaks and all that. I can encourage community, in my own way, even if I'm still hiding, so that we all can work together to create thing.", []);
