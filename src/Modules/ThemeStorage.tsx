...
const initMiracles = () => {
    ...
    miracles[CRAFTING] = ["divine inspiration to make a Legendary Object", "summon Divine Quality raw materials", "temporarily upgrade anyone within a 10 foot radius to a Master of any target craft"];
    miracles[LANGUAGE] = ["the abililty to understand any language", "remove someones understanding of a target language", "create an entire new language and specify speakers of it (losing previous language skills)"];
    miracles[BUGS] = ["summon a swarm of any target insect", "create new species of insects", "intuitively know what any insect desires"];
    miracles[ADDICTION] = ["cause addiction in any target", "permanently cure the addiction of any target", "cause a completely random effect"];
    miracles[SPYING] = ["the temporary ability to view anything within 100 miles", "divinely mark a target and hear anything through their ears and see anything through their eyes", "the temporary ability to hear any conversation within 10 miles"];
    ...
    miracles[MUSIC] = ["gain divine knowledge of how to perform any piece of music", "gain divine inspiration to create any musical performance", "gains divinely influence any who hear their music"];
...
const initQuests = () => {
    ...
    quest_possibilities[FAMILY] = [
        new QuestObject("A Sudden Turn!",
            ...
            [new StatExceedValueTrigger(false, Stat.VOID(10))],
            [new StatExceedValueTrigger(false, Stat.BLOOD(10))],
